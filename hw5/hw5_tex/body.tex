...
\noindent
{\bf Release date:}  10/3/19 \\
{\bf Due date:}  10/10/19, 23:00 (11 pm). Please \LaTeX{} or handwrite your homework solution and submit an electronic version.
...
\input{migration.tex}
\newpage
\input{voting_data.tex}
\newpage
\input{face_recognition.tex}
\newpage
\input{network_flow.tex}
