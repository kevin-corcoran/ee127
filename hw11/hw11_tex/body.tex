...
\noindent
{\bf Release date:} 11/21/19.\\
{\bf Due date:}  12/05/19, 23:00 (11 pm). Please \LaTeX{} or handwrite your homework solution and submit an electronic version. 
...
\begin{qunlist}
\input{duality_qp.tex}
\newpage
\input{kkt.tex}
\newpage
\input{matrix_dual.tex}
% \newpage
% \input{kkt_with_circles.tex}
\newpage
\input{svm_vs_ridge.tex}
